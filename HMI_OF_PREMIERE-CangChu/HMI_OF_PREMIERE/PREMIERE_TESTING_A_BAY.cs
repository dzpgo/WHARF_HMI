...
{
    public partial class PREMIERE_TESTING_A_BAY : FormBase
    {
        public PREMIERE_TESTING_A_BAY()
        {
            InitializeComponent();
        }
        ...
        //private string bayNO = "A";

        private string craneNO_1 = "1";
        private string craneNO_2 = "2";
        //private string craneNO_3 = "3_3";
        ...
        private void PREMIERE_TESTING_4_1_TO_4_3_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////
                conCraneStatusPanel_1.InitTagDataProvide(tagServiceName);
                conCraneStatusPanel_1.CraneNO = craneNO_1;
                lstConCraneStatusPanel.Add(conCraneStatusPanel_1);

                conCraneStatusPanel_2.InitTagDataProvide(tagServiceName);
                conCraneStatusPanel_2.CraneNO = craneNO_2;
