...
namespace UACSView
{
    public partial class FrmZ12BayOffLinePacking : FormBase
    {
        public FrmZ12BayOffLinePacking()
        {
            InitializeComponent();
            SetStyle(ControlStyles.AllPaintingInWmPaint
                | ControlStyles.OptimizedDoubleBuffer
                | ControlStyles.UserPaint, true);
            this.Load += FrmZ12BayOffLinePacking_Load;
        }
        #region  -----------------------------连接数据库--------------------------------
        ...
        void FrmZ12BayOffLinePacking_Load(object sender, EventArgs e)
        {
            //Z52跨5211区鞍座
            dicSaddleControls["Z0200011"] = Z51BayParkingArea_1;
            Z51BayParkingArea_1.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_1).Key;
            dicSaddleControls["Z0200021"] = Z51BayParkingArea_2;
            Z51BayParkingArea_2.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_2).Key;
            dicSaddleControls["Z0200031"] = Z51BayParkingArea_3;
            Z51BayParkingArea_3.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_3).Key;
            dicSaddleControls["Z0200041"] = Z51BayParkingArea_4;
            Z51BayParkingArea_4.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_4).Key;
            dicSaddleControls["Z0200051"] = Z51BayParkingArea_5;
            Z51BayParkingArea_5.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_5).Key;
            dicSaddleControls["Z0200061"] = Z51BayParkingArea_6;
            Z51BayParkingArea_5.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_6).Key;
            dicSaddleControls["Z0200071"] = Z51BayParkingArea_7;
            Z51BayParkingArea_5.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_7).Key;
            

            //Z52跨5212区鞍座
            dicSaddleControls["Z0200111"] = Z51BayParkingArea_11;
            Z51BayParkingArea_11.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_11).Key;
            dicSaddleControls["Z0200121"] = Z51BayParkingArea_12;
            Z51BayParkingArea_12.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_12).Key;
            dicSaddleControls["Z0200131"] = Z51BayParkingArea_13;
            Z51BayParkingArea_13.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_13).Key;
            dicSaddleControls["Z0200141"] = Z51BayParkingArea_14;
            Z51BayParkingArea_14.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_14).Key;
            dicSaddleControls["Z0200151"] = Z51BayParkingArea_15;
            Z51BayParkingArea_15.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_15).Key;
            dicSaddleControls["Z0200161"] = Z51BayParkingArea_16;
            Z51BayParkingArea_15.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_16).Key;
            dicSaddleControls["Z0200171"] = Z51BayParkingArea_17;
            Z51BayParkingArea_15.PosName = dicSaddleControls.FirstOrDefault(p => p.Value == Z51BayParkingArea_17).Key;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {              
                string sql1 = @"UPDATE UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE SET CONFIRM_FLAG = 30 WHERE STOCK_NO IN (SELECT STOCK_NO FROM UACS_YARDMAP_STOCK_DEFINE WHERE MAT_NO != 'NULL' AND STOCK_STATUS = 2 AND LOCK_FLAG = 0 AND STOCK_NO IN (SELECT STOCK_NO FROM UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE WHERE AREA_ID = 'Z02-P1'))";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql2 = @"UPDATE UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE SET CONFIRM_FLAG = 30 WHERE STOCK_NO IN (SELECT STOCK_NO FROM UACS_YARDMAP_STOCK_DEFINE WHERE MAT_NO != 'NULL' AND STOCK_STATUS = 2 AND LOCK_FLAG = 0 AND STOCK_NO IN (SELECT STOCK_NO FROM UACS_OFFLINE_PACKING_AREA_STOCK_DEFINE WHERE AREA_ID = 'Z02-P2'))";
