        ...
        private void GetAreaToYrad(string _CraneNO, int _type = 999)
        {
            string sql = @"select a.ID,a.CRANE_NO,a.AREA_ID,a.SADDLE_STRATEGY_ID,
                           ...
                           CASE
                              ...
                              WHEN a.FLOW_TO  = 'OFFLINE_PACKING_NORMAL_COIL_2_YARD' THEN '离线包装成品卷入库'  
                              WHEN a.FLOW_TO  = 'LINE_EXIT_D401_2_YARD_NORMAL_COIL' THEN 'D401出口最后三个鞍座钢卷入库'
                              ELSE a.FLOW_TO
                           END as FLOW_TO 
