...
namespace UACSView
{
    public partial class FrmYardToYardStraegy : FormBase
    {
        ...
        private void ShiftCoilByText()
        {
            ...
            txtCoilId.Text = dgvCoilStrategy.Rows[index].Cells["COIL_STRATEGY_ID"].Value.ToString();
        ...
        private void ShiftSaddleByText()
        {
            ...
            txtSaddleId.Text = dgvSaddleStrategy.Rows[index].Cells["SADDLE_STRATEGY_ID"].Value.ToString();
        ...
        public static void GetCoilStrategy(string _CraneNo, DataGridView _dgv)
        {
            ...
            try
            {
                string sql = @"SELECT a.DESC,b.SEQ,b.ID,a.X_MIN,a.X_MAX,a.Y_MIN,a.Y_MAX,a.X_DIR,a.LIST_UNIT_NO,a.MIN_EMPTY_SADDLES,a.FLAG_FIND_BY_PLAN,b.COIL_STRATEGY_ID FROM  
            ...
            if (hasSetColumn == false)
            {
                ...
                dt.Columns.Add("COIL_STRATEGY_ID", typeof(String));
        ...
        public static void GetSaddleStrategy(string _CraneNo, DataGridView _dgv)
        {
            ...
            try
            {
                string sql = @"SELECT a.DESC,b.SEQ,a.X_MIN,a.X_MAX,a.Y_MIN,a.Y_MAX,a.X_DIR,a.MIN_EMPTY_SADDLES,b.ID,b.SADDLE_STRATEGY_ID,
                                CASE
            ...
            if (hasSetColumn == false)
            {
                dt.Columns.Add("DESC", typeof(String));
                dt.Columns.Add("ID", typeof(String));
                dt.Columns.Add("SADDLE_STRATEGY_ID", typeof(String));
                dt.Columns.Add("SEQ", typeof(String));
                dt.Columns.Add("X_MIN", typeof(String));
                dt.Columns.Add("X_MAX", typeof(String));
                dt.Columns.Add("Y_MIN", typeof(String));
