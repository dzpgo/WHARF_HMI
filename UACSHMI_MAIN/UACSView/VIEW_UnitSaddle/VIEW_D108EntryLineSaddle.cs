...
namespace UACSView
{
    public partial class VIEW_D108EntryLineSaddle : FormBase
    {
        private Baosight.iSuperframe.Authorization.Interface.IAuthorization auth;
        #region -----------------------load加载----------------------------------


        public VIEW_D108EntryLineSaddle()
        {
            ...
            this.Load += VIEW_D108EntryLineSaddle_Load;
        ...
        private const string AREA_SAFE_D108_ENTRY = "AREA_SAFE_D108_ENTRY";
        ...
        void VIEW_D108EntryLineSaddle_Load(object sender, EventArgs e)
        {
            auth = FrameContext.Instance.GetPlugin<IAuthorization>() as IAuthorization;
            #region 绑定鞍座控件
            dicSaddleControls["D108WR1A01"] = coilUnitSaddle1;
            dicSaddleControls["D108WR1A02"] = coilUnitSaddle2;
            dicSaddleControls["D108WR1A03"] = coilUnitSaddle3;
            dicSaddleControls["D108WR1A04"] = coilUnitSaddle4;
            dicSaddleControls["D108WR1A05"] = coilUnitSaddle5;
            dicSaddleControls["D108WR1A06"] = coilUnitSaddle6;
            #endregion

            //实例化机组鞍座处理类
            saddleMethod = new UnitSaddleMethod(constData.UnitNo_3, constData.EntrySaddleDefine, constData.tagServiceName);
            saddleMethod.ReadDefintion();

            coilUnitStatus1.InitTagDataProvide(constData.tagServiceName);
            coilUnitStatus1.MyStatusTagName = AREA_SAFE_D108_ENTRY;

            lineSaddleTag.InitTagDataProvider(constData.tagServiceName);

            coilUnitSaddleButton1.MySaddleNo = "D108WR1A01";
            coilUnitSaddleButton2.MySaddleNo = "D108WR1A02";
            coilUnitSaddleButton3.MySaddleNo = "D108WR1A03";
            coilUnitSaddleButton6.MySaddleNo = "D108WR1A06";
            ...
            conEntrySpecAction1.UnitNo = constData.UnitNo_3;
            ...
            entrySaddleInfo.getEntrySaddleDt(dataGridViewSaddleMessage, constData.UnitNo_3);
            //是否开启定时器
            timer1.Enabled = true;
            //设定刷新时间
        ...
        {
            entrySaddleInfo.getL2PlanByUnitNo(dataGridViewPlanNum, constData.UnitNo_3);
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                coilEntryMode1.UnitNO = constData.UnitNo_3;
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                saddleMethod.GetCoilLabel(constData.UnitNo_3, lblNextCoil, label2);
        ...
        public static void ClearMemory()
        {
            ...
            {
                VIEW_D108EntryLineSaddle.SetProcessWorkingSetSize(System.Diagnostics.Process.GetCurrentProcess().Handle, -1, -1);
            }
        }
        #endregion
