...
namespace UACSControls
{
    public partial class UCArrow : UserControl
    {
        ...
        /// The direction
        /// </summary>
        private ArrowsDirection direction = ArrowsDirection.Right;
        ...
        public ArrowsDirection Direction
        {
        ...
        private void ResetPath()
        {
            ...
            switch (direction)
            {
                ...
                case ArrowsDirection.Bottom:
                    ...
                    break;
                case ArrowsDirection.Left_Right:
                    ps = new Point[] 
                    { 
                        new Point(0,this.Height/2),
                        new Point(40,0),
                    ...
                    break;
                case ArrowsDirection.Top_Bottom:
                    ps = new Point[] 
                    {
                       new Point(this.Width/2,0),
                       new Point(this.Width,40),
